...
package com.anansimobile.nge.IAB.util;
...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) throws Exception {
        ...
        if (mSetupDone) throw new Exception("IAB helper is already set up.");
        ...
        /* important security update in 'Google Play Billing Library'.
         * 
         *  see: https://code.google.com/p/marketbilling/source/detail?r=7bc191a004483a1034b758e1df0bda062088d840
         *  
         *
         */
     ...
     */
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener) throws Exception {
     ...
     */
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) throws Exception {
     ...
     *     handle it normally.
     */
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) throws Exception {
     ...
     */
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreSkus) throws IabException, Exception {
        ...
        (new Thread(new Runnable() {
            public void run() {
                ...
                try {
					...
					//FIXME: some exception catched, just ignore, fix it later.
				}
    ...
    public void queryInventoryAsync(QueryInventoryFinishedListener listener) throws Exception {
        queryInventoryAsync(true, null, listener);
    }

    public void queryInventoryAsync(boolean querySkuDetails, QueryInventoryFinishedListener listener) throws Exception {
     ...
     */
    void consume(Purchase itemInfo) throws IabException, Exception {
     ...
     */
    public void consumeAsync(Purchase purchase, OnConsumeFinishedListener listener) throws Exception {
        checkSetupDone("consume");
     ...
     * @param listener The listener to notify when the consumption operation finishes.
     */
    public void consumeAsync(List<Purchase> purchases, OnConsumeMultiFinishedListener listener) throws Exception {
        checkSetupDone("consume");
    ...
    void checkSetupDone(String operation) throws Exception {
        if (!mSetupDone) {
            logError("Illegal state for operation (" + operation + "): IAB helper is not set up.");
            throw new Exception("IAB helper is not set up. Can't perform operation: " + operation);
        }
    }
    ...
    void flagStartAsync(String operation) throws Exception {
        if (mAsyncInProgress) throw new Exception("Can't start async operation (" +
    ...
    void consumeAsyncInternal(final List<Purchase> purchases,
                              ...
                              final OnConsumeMultiFinishedListener multiListener) throws Exception {
        final Handler handler = new Handler();
